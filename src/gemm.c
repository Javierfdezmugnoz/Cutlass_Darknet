...
#include <omp.h>
#endif
#include "../Aux_constructor/cutlass_mmm.h"
...
// #include "/home/javifdez/git_repositories/Cutlass/include/cutlass/gemm/device/gemm.h"
...
{
    // Included by JFdez
    // 1st step: To display the number 2,25 from a CUTLASS function
    ...
    CutlassSgemmNN(M, N, K, ALPHA, A_gpu, lda, B_gpu, ldb, BETA, C_gpu, ldc, NULL, NULL, NULL);
    // CHECK_CUDA(status);
}
